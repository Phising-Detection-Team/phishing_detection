...
try:
    round_obj = Round(name="Test", status="pending", total_emails=1, processed_emails=0,
                      accuracy_true_negatives=0.0, accuracy_true_positives=0.0,
                      accuracy_false_negatives=0.0, accuracy_false_positives=0.0, cost=0.0)
    session.add(round_obj)
    session.commit()
    
    # Valid confidence
    email = Email(
        round_id=round_obj.id, subject="T", sender="t@t.com", recipient="r@r.com",
        body="B", generator_verdict="phishing", detector_verdict="phishing",
        detector_confidence=0.95, is_phishing=True,
        generator_latency_ms=100, detector_latency_ms=50, judge_latency_ms=25, cost=0.01
    )
    session.add(email)
    session.commit()
    ...
    try:
        email2 = Email(
            round_id=round_obj.id, subject="T", sender="t@t.com", recipient="r@r.com",
            body="B", generator_verdict="phishing", detector_verdict="phishing",
            detector_confidence=1.5, is_phishing=True,
            generator_latency_ms=100, detector_latency_ms=50, judge_latency_ms=25, cost=0.01
        )
        session.add(email2)
        session.commit()
...
# ============================================================================
try:
    round_obj2 = Round(name="Test2", status="pending", total_emails=10, processed_emails=0,
                       accuracy_true_negatives=0.0, accuracy_true_positives=0.0,
                       accuracy_false_negatives=0.0, accuracy_false_positives=0.0, cost=0.0)
...
try:
    # Valid status
    round_obj3 = Round(name="Test3", status="running", total_emails=1, processed_emails=0,
                       accuracy_true_negatives=0.0, accuracy_true_positives=0.0,
                       accuracy_false_negatives=0.0, accuracy_false_positives=0.0, cost=0.0)
    ...
    try:
        bad_round = Round(name="Bad", status="invalid_status", total_emails=1, processed_emails=0,
                         accuracy_true_negatives=0.0, accuracy_true_positives=0.0,
                         accuracy_false_negatives=0.0, accuracy_false_positives=0.0, cost=0.0)
...
# ============================================================================
try:
    round_obj4 = Round(name="Test4", status="pending", total_emails=1, processed_emails=0,
                       accuracy_true_negatives=0.0, accuracy_true_positives=0.0,
                       accuracy_false_negatives=0.0, accuracy_false_positives=0.0, cost=0.0)
    ...
    try:
        bad_email = Email(
            round_id=round_obj4.id, subject="T", sender="t@t.com", recipient="r@r.com",
            body="B", generator_verdict="phishing", detector_verdict="phishing",
            detector_confidence=0.5, is_phishing=True,
            generator_latency_ms=-100, detector_latency_ms=50, judge_latency_ms=25, cost=0.01
        )
...
# ============================================================================
try:
    round_obj5 = Round(name="Test5", status="pending", total_emails=2, processed_emails=0,
                       accuracy_true_negatives=0.0, accuracy_true_positives=0.0,
                       accuracy_false_negatives=0.0, accuracy_false_positives=0.0, cost=0.0)
    ...
    # Create 2 emails
    email1 = Email(
        round_id=round_obj5.id, subject="E1", sender="t@t.com", recipient="r@r.com",
        body="B", generator_verdict="phishing", detector_verdict="phishing",
        detector_confidence=0.5, is_phishing=True,
        generator_latency_ms=100, detector_latency_ms=50, judge_latency_ms=25, cost=0.01
    )
    email2 = Email(
        round_id=round_obj5.id, subject="E2", sender="t@t.com", recipient="r@r.com",
        body="B", generator_verdict="phishing", detector_verdict="phishing",
        detector_confidence=0.5, is_phishing=True,
        generator_latency_ms=100, detector_latency_ms=50, judge_latency_ms=25, cost=0.01
    )
    ...
    override1 = Override(email_id=email1.id, verdict="phishing", email_test_id=5000)
    ...
    try:
        override2 = Override(email_id=email2.id, verdict="phishing", email_test_id=5000)
...
# ============================================================================
try:
    round_obj6 = Round(name="Test6", status="pending", total_emails=1, processed_emails=0,
                       accuracy_true_negatives=0.0, accuracy_true_positives=0.0,
                       accuracy_false_negatives=0.0, accuracy_false_positives=0.0, cost=0.0)
    ...
    email = Email(
        round_id=round_obj6.id, subject="T", sender="t@t.com", recipient="r@r.com",
        body="B", generator_verdict="phishing", detector_verdict="phishing",
        detector_confidence=0.5, is_phishing=True,
        generator_latency_ms=100, detector_latency_ms=50, judge_latency_ms=25, cost=0.01
    )
    ...
    for agent in ["generator", "detector", "judge"]:
        api_call = API(email_id=email.id, agent_type=agent, token_used=100, latency_ms=50, cost=0.001)
    ...
    # Invalid agent type
    try:
        bad_api = API(email_id=email.id, agent_type="invalid_agent", token_used=100, latency_ms=50, cost=0.001)
        session.add(bad_api)
        session.commit()
